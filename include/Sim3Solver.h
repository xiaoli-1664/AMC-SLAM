...
public:
    ...
    Sim3Solver(MultiKeyFrame* pKF1, MultiKeyFrame* pKF2, const std::vector<MapPoint*> &vpMatched12, const bool bFixScale = true,
               const vector<MultiKeyFrame*> vpKeyFrameMatchedMP = vector<MultiKeyFrame*>());
...
protected:
    ...
    void Project(const std::vector<Eigen::Vector3f> &vP3Dw, std::vector<Eigen::Vector2f> &vP2D, Eigen::Matrix4f Tcw, vector<GeometricCamera*>& vpCamera, vector<int>& vncam, vector<Sophus::SE3f>& vTcb);
    void FromCameraToImage(const std::vector<Eigen::Vector3f> &vP3Dc, std::vector<Eigen::Vector2f> &vP2D, vector<GeometricCamera*>& vpCamera, vector<int>& vncam, vector<Sophus::SE3f>& vTcb);
...
protected:
    ...
    std::vector<Eigen::Vector3f> mvX3Db1;
    std::vector<Eigen::Vector3f> mvX3Db2;
    ...
    vector<Sophus::SE3f> vTc1b;
    vector<Sophus::SE3f> vTc2b;
    ...
    vector<GeometricCamera*> vpCamera1, vpCamera2;
