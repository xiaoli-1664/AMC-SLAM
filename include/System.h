...
public:
    ...
    Sophus::SE3f TrackMultiCamera(const std::vector<cv::Mat> &vIm, const std::vector<double> &vTimestamps, string filename="");
    ...
    void LoadAmvImages(vector<vector<string>>& vstrImage, vector<vector<double>>& vTimestamps);
...
private:
    ...
    Settings* settings_;
    string mDatesetFileName;
    vector<string> mvstrImageFilenames;
    vector<string> mvstrTimestampsFile;
