...
Eigen::Matrix3f GeometricTools::ComputeF12(MultiKeyFrame* &pKF1, MultiKeyFrame* &pKF2)
{
    ...
    const Eigen::Matrix3f K1 = pKF1->mvpCamera.back()->toK_();
    const Eigen::Matrix3f K2 = pKF2->mvpCamera.back()->toK_();
